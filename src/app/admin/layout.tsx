...
export default function AdminLayout({ children }: { children: React.ReactNode }) {
    return (
        <div className="min-h-screen flex bg-zinc-50 font-sans dark:bg-black relative">
            <section className="basis-2/6 sticky top-24 self-start flex flex-col items-stretch mt-8 px-4 gap-y-2">
            ...
            <section className="border-l-2 basis-4/6 p-6 flex flex-col items-stretch justify-start w-full">
                {children}
            </section>
